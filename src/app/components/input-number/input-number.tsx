...
// NB! Соображение по архитектуре
// Папка components находится в `app` неслучайно, я всегда специфические для
// отдельных страниц компоненты храню в мини-папках `components` для этих конкретных
// страниц и переношу их в общую папку `/src/components` (которая в этом проекте
// не успела создаться) только когда понимаю, что они используются более чем в одном
// месте, да и то делаю это с сомнением. Три использования — точно общий компонент.
